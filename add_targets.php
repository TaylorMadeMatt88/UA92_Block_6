    ...
    <body>
        ...
        <div class="row-sm">
			<div class="col">
				...
				<p style="font-size:4vw;">ADD TARGETS</p>
				</div>
			</div>
		</div>
        ...
        <div class="row-sm">
		    <div class="col">
		        <div class="form-layout">
                    <form method="post" action="add_targets.php">
                        <label style="font-size:2vw;">Target Name</label>      
                            <input type="text" name="name" required />
                            <br>
                            <label style="font-size:2vw;">Target Type</label>          
                            <input type="text" name="target_type" required />
                            <br>
                            <label style="font-size:2vw;">First Mission Date</label>    
                    ...
                    <!--Form with required inputs for Target Name, Target Type, First Mission Date & Number Of Missions - MR-->
        ...
        if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO target (name, target_id, target_type, first_mission, no_of_missions) VALUES ('$name', '$target_id', '$target_type', '$first_mission', '$no_of_missions')";
