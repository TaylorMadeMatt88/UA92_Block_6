<html>
    ...
    <body>
        ...
        <table id="table">
            <tr>
                ...
                <th width="300px">Target Name</th>
                <th width="300px">Target Type</th>
                <th width="300px">Date Of First Mission</th>
                <th width="200px">Number Of Missions</th>
            </tr>
            <!-- A simple table with the column headers inserted and spaced accordingly - MR -->

            <?php
            $sql = mysqli_query($link, "SELECT target_id, name, target_type, first_mission, no_of_missions FROM target");
    ...
    <div class="row">
        ...
        <div class="form-layout">
                <h3>Number Of Missions To Target Name</h3>
                ...
                <?php
                    $sql = mysqli_query($link, "SELECT target_id, name, first_mission, target_type, no_of_missions FROM target");
                    while ($row = $sql->fetch_assoc()){
                    echo "
                    '{$row['name']}',
                    ";
                ...
                <?php 
                    ...
                    backgroundColor: '#DA6F65',
                    borderColor: '#DA6F65',
                    data: [
                    ";
                /* The chart JS styling continues as we set the line chart's line & dot colour with backgroundColor & borderColor
