<html>
    ...
    <body>
        ...
        <table id="table">
            <tr>
                <th width="150px">Astronaut ID</th>
                <th width="300px">Astronaut Name</th>
                <th width="300px">Number Of Missions</th>
            </tr>
            <!-- A simple table with the column headers inserted and spaced accordingly - MR -->

            <?php
            $sql = mysqli_query($link, "SELECT astronaut_id, name, no_of_missions FROM astronaut");
        ...
        <div class="row">
            <div class="col">
                <div class="form-layout">
                    <h3>Number Of Missions Per Astronaut</h3>
                    ...
                    <?php
                        $sql = mysqli_query($link, "SELECT name, no_of_missions FROM astronaut");
                        while ($row = $sql->fetch_assoc()){
                        echo "
                        '{$row['name']}',
                        ";
